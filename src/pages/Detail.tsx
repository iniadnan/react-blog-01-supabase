    ...
    return (
        <main className="py-10">
            <form id="form__modal" name="form__modal" className="py-5 w-full max-w-[800px] mx-auto">
                <InputForm addClass="mb-5" type="text" name="title" id="title" title="Title" value={post.title} />
                <InputForm addClass="mb-5" type="text" name="synopsis" id="synopsis" title="Synopsis" value={post.synopsis} />
                <InputForm addClass="mb-5" type="text" name="slug" id="slug" title="Slug" value={post.slug} />
                <InputForm addClass="mb-5" type="text" name="author" id="author" title="Author" value={post.author} />
                <div className="mb-5">
