            ...
            <main className="w-full md:pt-10 pb-10">
                <div className="container mx-auto px-5 w-full md:w-[900px] lg:w-[1200px]">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {posts.map((post) => (
                            <article className="relative bg-gray-50 hover:bg-gray-100 border rounded-lg py-3 px-5" key={post.slug}>
                            <button
                                type="button"
                            ...
                            <Link to="/detail" className="block">
                                <section className="mb-2.5">
                                    <h2 className="font-semibold text-lg md:text-xl text-gray-700">{post.title}</h2>
                                </section>
                                <div>
                                    <p className="text-sm md:text-base text-gray-700">{post.synopsis}</p>
                                </div>
                            </Link>
                        </article>
                        ))}
